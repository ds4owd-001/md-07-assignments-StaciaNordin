...
author: "Stacia Nordin, that took me forever and a day"
format:
  html:
...
2.  What's the `tidyverse` Package? Describe in maximum two sentences below.
    -   From <https://www.tidyverse.org/>: 'tidyverse makes data science faster, easier and more fun' :) The tidyverse is an opinionated collection of R packages designed for data science. All packages share an underlying design philosophy, grammar, and data structures.
...
1.  Starting with the `waste_data_long_mean` object, execute the code and observe the output in the Console. Would you publish this table in this format in a report?
    -   no, I would make it look nice like you showed us in class :)
